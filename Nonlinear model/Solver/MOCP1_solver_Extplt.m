function [t, u] = MOCP1_solver_Extplt(A, f, dfdu, u_init, tspan, h)
...
for n = 1:nt-1
    ...
    U0 = u(:,n);
    options = optimoptions('fsolve', 'Display', 'off', 'MaxIterations', 100, 'TolFun', 1e-12);
    if has_jac
