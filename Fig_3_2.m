...
yline(0.22, '--', '0.22', 'FontSize', 20, 'LabelHorizontalAlignment', 'right', 'LabelVerticalAlignment', 'top', 'LineWidth', 2, ...
...
yline(0.151, '--', '0.151', 'FontSize', 20, 'LabelHorizontalAlignment', 'right', 'LabelVerticalAlignment', 'top', 'LineWidth', 2, ...
'FontName', 'Times New Roman');
hold off;
set(gca, 'XScale', 'log');
xlim([1e-4, 1e4]);
