function [t, u] = BDF5_solver(A, f, dfdu, u_init, tspan, h)
...
N = size(u_init,1);
if size(u_init,2) ~= 5
    error('u_init must be N x 5 matrix.');
end
...
alpha_past = [-300/137, 300/137, -200/137, 75/137, -12/137];
beta = 60/137;
